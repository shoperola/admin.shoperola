...
function FooterSocialMedia(props) {
    ...
    const handleSubmit = async (e) => {
        if (data[0]?._id) {
            let resData = await axios.patch(`${API_URl}/admin/update_social/${data[0]?._id}`, {
            ...
            let res = await axios.post(`${API_URl}/admin/add_social`, {
                facebook: State.facebook,
                twitter: State.twitter,
                instagram: State.instagram,
                linkedin: State.linkedin,
                                                    ...
                                                    <div className="row">
                                                        <div className="col-lg-12">
                                                            <div className="form-group">
                                                                ...
                                                                <input value={State.facebook} name="facebook" onChange={handleChange} type="text" className="form-control input-field" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="row">
                                                        <div className="col-lg-12">
                                                            <div className="form-group">
                                                                ...
                                                                <input value={State.twitter} name="twitter" onChange={handleChange} type="text" className="form-control input-field" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="row">
                                                        <div className="col-lg-12">
                                                            <div className="form-group">
                                                                ...
                                                                <input value={State.instagram} name="instagram" onChange={handleChange} type="text" className="form-control input-field" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="row">
                                                        <div className="col-lg-12">
                                                            <div className="form-group">
                                                                ...
                                                                <input value={State.linkedin} name="linkedin" onChange={handleChange} type="text" className="form-control input-field" />
                                                            </div>
                                                        </div>
                                                    </div>
