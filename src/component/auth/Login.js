...
function Login(props) {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(!loading);
        axios
            .post("https://api.tellytell.com/sigin_admin", { ...user })
            .then((response) => {
                setLoading(false);
                                        ...
                                        <form>
                                            <div className="form-group">
                                                ...
                                                <input
                                                    ...
                                                    type="text" className="form-control input-field" placeholder="Enter Email ID" />
                                            </div>
                                            ...
                                            <div className="form-group">
                                                ...
                                                <input
                                                    ...
                                                    name="password"
                                                    onChange={handleChange}
                                                    type="password" className="form-control input-field" placeholder="Enter password" />
                                            </div>
                                            ...
                                            <div className="mt-3 text-right">
                                                ...
                                                <button
                                                    ...
                                                    onClick={handleSubmit} className="btn btn-primary w-sm waves-effect waves-light" >
                                                    <ClipLoader
                                                        color="blue"
                                                        loading={loading}
                                                        size={20}
