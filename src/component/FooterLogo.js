...
function FooterLogo(props) {
    ...
    const handleSubmit = async (e) => {
        if (data[0]?._id) {
            ...
            let resData = await axios.patch(`${API_URl}/admin/update_logo/${data[0]?._id}`, formData, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            })
                                                        ...
                                                        <div className="col-lg-12">
                                                            <div className="form-group mb-30 width-100 row">
                                                                ...
                                                                <div className="col-md-8">
                                                                    <input name="logo" onChange={handleChange} type="file" className="form-control input-field" />
