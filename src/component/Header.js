...
function Header(props) {
    ...
    useEffect(() => {
        axios
            .get(`https://api.tellytell.com/admin`, {
                headers: {
                ...
                <div className="d-flex">
                    ...
                    <div className="dropdown d-inline-block">
                        ...
                        <div className="dropdown-menu dropdown-menu-right">
                            {/* <!-- item--> */}
                            <Link className="dropdown-item" to="/resetPassword"><span className="align-middle">Change Password</span></Link>
                            <span onClick={signout}>
                                <Link className="dropdown-item" to="/"><span className="align-middle">Sign out</span></Link>
                            </span>
                        </div>
                    </div>
